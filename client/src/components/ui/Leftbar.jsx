...
function Leftbar({ isOpen = false, onClose = () => {} }) {
  ...
  return (
    <>
      ...
      <div
        className={`
        fixed h-full z-50 bg-black border-r border-gray-800 transition-transform duration-300 ease-in-out
        ...
        <div className="flex flex-col h-full p-4">
          ...
          <nav className="flex-1 space-y-2">
            ...
            <Link
              ...
              className="flex items-center space-x-4 p-3 rounded-full hover:bg-gray-900 cursor-pointer transition-colors"
            >
            ...
            {/* Language Switcher */}
            <div className="flex items-center space-x-4 p-3 rounded-full">
              <svg
                className="w-6 h-6"
                fill="none"
                stroke="currentColor"
